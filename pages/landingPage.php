...
<body>
      ...
      <div class="jumbotron">
        <div class="container">
            ...
            <p class="lead">You've finished register and login session, please enjoy our system</p>
            <hr class="my-4">
            <p>If you have something to ask, don't shy to ask our customer service. Click the button below. </p>
            <p class="lead">
